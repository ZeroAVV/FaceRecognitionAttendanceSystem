...
audio_file = os.path.dirname(__file__) + 'a.wav'
##################################################################################
...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'ayansvarekar@gmail.com' ")
    webbrowser.open('https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=GFrJzkbtFjpZTLPgLBpRXFmtlHgRzHGZRGhKpzqzDKPsxpvdFMsGNVWXQxRgBwQwkbrW', new=2)
...
window.title("Goldcrest High Vashi")
...
message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="#00aeff" ,fg="red"  ,width=39 ,height=1, activebackground = "purple" ,font=('times', 15, ' bold '))
